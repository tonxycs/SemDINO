...
[[Paper]](https://arxiv.org/pdf/2606.09772)


## Release

-  🔥**News**: ```2026/8/1```: Our Datasets and necessary weight updated.
-   ```2026/6/15```: our train, test, pred code updated.
-   ```2026/6/1```: SemDINO(draft) new released～✌️.
